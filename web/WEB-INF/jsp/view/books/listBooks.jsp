...
<head>
    ...
    <title>BookGoals - View Books List</title>
            ...
            <div class="row">
                ...
                <c:if test="${sucessDelete}">
                    <div class="alert alert-success">
                        Book (<strong><c:out value="${bookName}"/></strong>) is successfully deleted.
                    </div>
                </c:if>
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <c:forEach items="${booksList}" var="book">
                                        <tr>
                                            ...
                                            <td><c:out value="${book.authorsCollection.toString()}"/>
                                            </td>
                                            <td><c:out value="${book.booksCategoryid}"/></td>
                                            <th>
                                        ...
                                        <!-- action forms -->
                                        <form action="books" method="post" id="deleteForm<c:out value="${book.id}" />">
                                            <input type="hidden" name="mainAction" value="mainDelete"/>
                                            <input type="hidden" name="bookId" value="<c:out value="${book.id}"/>"/>
                                        </form>
                                        <!-- action forms -->
                                        <!-- DELETE CONFIRMATION MODAL -->
                                        <div class="modal fade" id="deleteConfModal<c:out value="${book.id}" />" tabindex="-1"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        Are you sure you want to delete book: <strong><c:out value="${book.name}" /></strong>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="submit" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                                                        <button type="submit" class="btn btn-danger" form="deleteForm<c:out value="${book.id}"/>">Confirm</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
