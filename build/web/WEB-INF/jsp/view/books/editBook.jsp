...
<head>
    ...
    <title>BookGoals - Edit Book (<c:out value="${book.name}"/>)</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit Book (<c:out value="${book.name}" />)</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <form form method="post" action="books">
                                        <input type="hidden" name="mainAction" value="mainEdit" />
                                        <c:choose>
                                                <c:when test="${success == true}">
                                                    <div class="alert alert-success">
                                                        <button type="button" aria-hidden="true" class="close"></button>
                                                        <span>Changes on Book <strong>${book.name}</strong> - are saved.</span>
                                                    </div>
                                                </c:when>
